...
exports.default = {
    fetchAllProducts: (_a) => __awaiter(void 0, [_a], void 0, function* ({ limit = 20, page = 1, sort = 'prod.product_id', order = 'ASC', search = '', category, tags, model, priceRange, exclude_models }) {
        try {
      ...
      `;
            const [countResults] = yield db_1.default.query(countQuery, values.slice(0, -2));
            // Issue with the total query, it returns total with duplicated rows. Returns total 45 yet the total is supposed to be 26.
