...
exports.default = {
    fetchAllCategories: (_a) => __awaiter(void 0, [_a], void 0, function* ({ limit = 4, page = 1, sort = 'cat.category_id', order = 'DESC', search = '' }) {
        ...
        JOIN ${helpers_1.tables.seo_url} seo ON cat.category_id = seo.value AND seo.key = 'path'
        WHERE cat.status = 1 
      `;
            let whereClause = '';
            if (search) {
    ...
    fetchCategoryBySlug: (slug) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const query = `
        SELECT 
          cat.*,
    ...
    fetchAllSlugs: () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        JOIN ${helpers_1.tables.category} cat ON seo.value = cat.category_id
