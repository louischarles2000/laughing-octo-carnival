...
exports.categoryQueryControllers = {
    ...
    getCategoryBySlug: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const category = yield categories_1.default.fetchCategoryBySlug(categorySlug);
            if (!category) {
                return res.status(404).json({ Message: "Category not found" });
            }
    ...
    getCategorySlugs: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const slugs = yield categories_1.default.fetchAllSlugs();
            if (!slugs) {
                return res.status(404).json({ Message: "Category not found" });
            }
